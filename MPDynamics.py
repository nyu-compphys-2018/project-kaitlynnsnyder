...
def main():
 ...
 #   scalingWNumParticles()
    x, xG = runTimesSquare(MPRadius,MPX,MPY, NumSteps,MPVelocity)

    np.savetxt('Velocity_applied_force.txt', (x,xG),' ',fmt='%s')
 
 #   runTimesSquare(MPRadius,MPX,MPY, NumSteps,MPVelocity)
 #   runBrownian(MPRadius,MPX,MPY, NumSteps,MPVelocity)
