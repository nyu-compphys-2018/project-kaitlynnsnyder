...
def main():
    ...
    for i in range(5):
        ...
        X,gX=runAnimation(MPRadius,MPX,MPY, NumSteps,MPVelocity)

        distance.append(X[-1])

    np.savetxt('Single Times Square path.txt', X,fmt='%s')
    np.savetxt('dTSistanceAfter300Steps.txt', distance,fmt='%s')
